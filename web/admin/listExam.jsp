                ...
                <div class="col-md-2 p-0">
                    <div class="sidebar-light d-flex flex-column bg-white"
                        ...
                        <div class="menu mt-5" style="display: flex;
                            ...
                            <a href="admin/listUser.jsp" class="nav-item nav-link"
                               >
                                <div
                                    class="menu-item d-flex align-items-center  "
                                    style="gap: 5px; color: black;">
                            ...
                            <a href="admin/listLesson.jsp" class="nav-item nav-link" >
                                <div
                                    class="menu-item d-flex align-items-center "
                                    style="gap: 5px; color: black;">
                                    <svg
                            ...
                            <a href="admin/listQuiz.jsp" class="nav-item nav-link" >
                                <div
                                    class="menu-item d-flex align-items-center "
                                    style="gap: 5px; color: black;">
                                    <img src="${pageContext.request.contextPath}/img/quiz.png" class="me-3"
                                         alt="Calendar Icon"
                                         style="width: 24px; height: 24px;">
                                    <span class="menu-text">Bài Ôn Tập</span>
                                </div>
                            </a>
                            <a href="ListExamController" class="nav-item nav-link" style="background-color: #ff6600; border-radius: 15px; width: 200px; height: 50px; padding: 12px 30px;">
                                <div class="menu-item d-flex align-items-center " style="gap: 5px; color: black;">
                                    <img src="${pageContext.request.contextPath}/img/quiz.png" class="me-3" alt="Calendar Icon" style="width: 24px; height: 24px;" >
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach var="exam" items="${listE}">
                                            <tr>
                                                <td style="padding: 20px;">${exam.examName}</td>
                                                <td style="padding: 20px;">
                                                    <c:out value="${classMap[exam.class_id]}"/>
                                                </td>
                                                <td style="padding: 20px;">
                                                    <c:out value="${subjectMap[exam.subject_id]}"/>
                                                </td>
                                                <td style="padding: 20px; gap: 20px; display: flex;">
                                                    <a href="DeleteExamController?id=${exam.examId}">
                                                    ...
                                                    <a href="EditExamController?id=${exam.examId}">
