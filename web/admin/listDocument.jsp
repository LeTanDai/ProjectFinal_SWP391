                                        ...
                                        <c:forEach var="entry" items="${submapdocument}">
                                            <tr>
                                                ...
                                                <td style="padding: 20px; gap: 20px; display: flex;">
                                                    ...
                                                    <a href="AdminUpdateDocumentController?docid=${entry.key.getDocId()}" role="operatedocument" data-value="edit" style="background: none; border: none; padding: 0;">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
