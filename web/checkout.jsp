        ...
        <div class="container-payment" style="text-align: center; margin-top: 50px;">
            ...
            <div class="user-info">
                ...
                <div id="qrcode" style="text-align: center;">
                    <img src="https://img.vietqr.io/image/MB-0926615662-compact.png?amount=30000&addInfo=<%= user.getPhone() %>" alt="QR Code" /> 
        ...
        <script>
            function startTimer(duration, display) {
                ...
                const interval = setInterval(function () {
                    ...
                    $(display).text(seconds); // Sử dụng jQuery để cập nhật giá trị

                    if (--timer < 0) {
                        clearInterval(interval);
                        $('#qr-timer').html('Mã QR đã hết hạn');
                    }
                }, 1000);
            }
