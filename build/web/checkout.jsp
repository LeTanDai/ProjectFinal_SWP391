...
<body>
    ...
    <div class="container-payment" style="text-align: center; margin-top: 50px;">
        ...
        <div class="user-info"> 
            ...
            <div id="qrcode" style="text-align: center;">
                <img src="https://img.vietqr.io/image/MB-0702795560-compact.png?amount=30000&addInfo=Update%20account" alt="QR Code" /> <!-- Hiển thị mã QR -->
  ...
  <script>
    ...
    let paid_price = 20000; // Số tiền cần thanh toán
    ...
    window.onload = function() {
        ...
        }, 20000); // Thay đổi thời gian delay tại đây
    };
    ...
    async function checkPaid(price) {
        ...
        try {
            ...
            if (LastPrice >= price && (currentTime - lastPaidTime) <= 60000) {
