                ...
                <div class="col-md-2 p-0">
                    <div class="sidebar-light d-flex flex-column bg-white"
                        ...
                        gap: 30px; ">
                            ...
                            <a href="listQuiz.jsp" class="nav-item nav-link" style="background-color: #ff6600; border-radius: 15px; width: 200px; height: 50px; padding: 12px 30px;">
                                <div
                                    class="menu-item d-flex align-items-center "
                                    style="gap: 5px; color: black;">
