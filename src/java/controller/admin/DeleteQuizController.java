 ...
 * @author TanDai
 */
@WebServlet(name="DeleteQuizController", urlPatterns={"/admin/DeleteQuizController"})
public class DeleteQuizController extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            flashDAO.deleteFlashCard(flashCardId); 
            request.setAttribute("mess", "Xóa câu hỏi thành công!");
        }catch(Exception ex) {
            log("DeleteQuizController error:" + ex.getMessage());
        }finally {
