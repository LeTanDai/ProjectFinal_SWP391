...
public class ExamDetailController extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        request.setAttribute("ex", exam);
        
        List<Exam> listE = dao.getAllExam();
        //b2 : set data to jsp
        request.setAttribute("listEx", listE);
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(ExamDetailController.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
